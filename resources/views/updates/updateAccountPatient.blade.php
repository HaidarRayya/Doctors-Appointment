...
<head>
    ...
    <link rel="stylesheet" href="css/updateAccountPatient.css">
    ...
    <div class="page">
        ...
        <nav>
            ...
            @if (Auth::user())
                ...
                @elseif(Auth::user()->role === 'patient')
                    <a href="/updateAccountPatient/{{ $user->id }}" class="this-page"> تعديل الملف الشخصي </a>
                @else
        ...
        <div class="forms" id="forms">
            ...
            <div class="patient reg">
                <form method="POST" action="/updateAccountPatient/{{ $user->id }}" enctype="multipart/form-data"

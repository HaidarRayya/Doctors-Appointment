...
<body>
    <div class="page">
        ...
        <nav>
            <a href="/admin" class="this-page"> صفحة التحويل </a>
            <a href="/transactionPage"> جدول الحوالات </a>
        </nav>
    </div>
    <section>
        <div class="form">
            <h2>تعبئة جديدة لبائع</h2>
            <form method="POST" action="/adminTransformation" class="login" id="lofinForm">
                @csrf
                <label for="email">البريد الالكتروني</label>
                <input type="email" id="email" name="email" value="{{ old('email') }}">
                <label for="number">القيمة</label>
                <input type="number" id="number" name="value" value="{{ old('value') }}">

...
<head>
    ...
    <link rel="stylesheet" href="css/dailyDatesPatientToDoctor.css" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" action="/addAppointment">
                                            ...
                                            <input name='patient_id' value="{{ $patientId }} " hidden />
                                            <input name='appointmentDate' value="{{ $d[3] }} "hidden />
                                            <input name='appointmentTime' value="{{ $d[2] }}" hidden />
                        ...
                        @else
                            ...
                            @for ($i = 0; $i < count($dates); $i++)
                                @foreach ($appointments as $appointment)
                                    @if ($appointment->appointmentDate === $dates[$i][3])
                                        <tr>
